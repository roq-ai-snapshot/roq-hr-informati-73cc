...
export function EmployeeListPage(props: EmployeeListPageProps) {
    ...
    async () =>
      getEmployees({
        relations: [
          'user',
          'company',
          'payroll_employee_payroll_idTopayroll',
          'payroll_payroll_employee_idToemployee.count',
          'vacation.count',
        ],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('payroll', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'payroll_employee_payroll_idTopayroll',
          header: 'Payroll Employee Payroll Id Topayroll',
          accessorKey: 'payroll_employee_payroll_idTopayroll',
          cell: ({ row: { original: record } }: any) => (
            <Link
              as={NextLink}
              onClick={(e) => e.stopPropagation()}
              href={`/payrolls/view/${record.payroll_employee_payroll_idTopayroll?.id}`}
            >
              {record.payroll_employee_payroll_idTopayroll?.salary}
            </Link>
          ),
        }
      : null,
    hasAccess('payroll', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'payroll_payroll_employee_idToemployee',
          header: 'Payroll Payroll Employee Id Toemployee',
          accessorKey: 'payroll_payroll_employee_idToemployee',
          cell: ({ row: { original: record } }: any) => record?._count?.payroll_payroll_employee_idToemployee,
        }
      : null,
