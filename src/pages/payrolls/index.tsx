...
export function PayrollListPage(props: PayrollListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getPayrolls({
        relations: ['employee_payroll_employee_idToemployee', 'employee_employee_payroll_idTopayroll.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('employee', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'employee_payroll_employee_idToemployee',
          header: 'Employee Payroll Employee Id Toemployee',
          accessorKey: 'employee_payroll_employee_idToemployee',
          cell: ({ row: { original: record } }: any) => (
            <Link
              as={NextLink}
              onClick={(e) => e.stopPropagation()}
              href={`/employees/view/${record.employee_payroll_employee_idToemployee?.id}`}
            >
              {record.employee_payroll_employee_idToemployee?.id}
            </Link>
          ),
        }
      : null,
    hasAccess('employee', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'employee_employee_payroll_idTopayroll',
          header: 'Employee Employee Payroll Id Topayroll',
          accessorKey: 'employee_employee_payroll_idTopayroll',
          cell: ({ row: { original: record } }: any) => record?._count?.employee_employee_payroll_idTopayroll,
        }
      : null,
